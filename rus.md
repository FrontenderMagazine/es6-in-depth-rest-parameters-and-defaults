...
*   Если функции передан `undefined`, то это считается эквивалентным тому,
...
К сожалению, пока нет других браузеров, поддерживающих описанные параметры и значения. В V8 недавно была
...
точки зрения не являются  каким-то нововведением, они могут сделать сигнатуры функций
